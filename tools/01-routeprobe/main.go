...
var lineRules = []lineRule{
	...
	{Name: "China Mobile CMI", Re: regexp.MustCompile(`(?i)(chinamobileinternational|\bcmi\b|cmi\.|as58453|223\.120\.)`)},
	{Name: "China Mobile CMNET", Re: regexp.MustCompile(`(?i)(cmnet|cmcc|chinamobile|as9808|as56040|221\.183\.|221\.176\.|120\.198\.)`)},
